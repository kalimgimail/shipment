/*
    Question: 
    33. Print your array in its orignal order.
...
const WishListcp : string[] = [...WishList]
WishListcp.sort((a,b)=>b.localeCompare(a))
console.log("Orignal content of Array:", WishList)
