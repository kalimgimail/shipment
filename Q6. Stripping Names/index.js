...
*/
var personName = "Person Name\tKal\neem\n";
var personNameWithoutWhteSpaces = personName.replace(/\t+/g, '');
 ...
 */
var stringWithWhitespace = "  Hello,\n\tthis is a string\n\twith various white space characters.\n  ";
var StringAfterFilterSplitJoin = stringWithWhitespace
    .split('')
    .filter(function (char) { return (!/\s/.test(char)); })
    .join('');
